...
<digital_object_identifier><xsl:value-of select="//gmd:otherCitationDetails/gco:CharacterString"/></digital_object_identifier>
<time_period_coverage_start><xsl:value-of select="//gml:begin/gml:TimeInstant/gml:timePosition"/></time_period_coverage_start>
<time_period_coverage_end></time_period_coverage_end>
<url_fra></url_fra>
